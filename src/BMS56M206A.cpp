...
Others:      none
**********************************************************/
BMS56M206A::BMS56M206A(uint8_t intPin, TwoWire *theWire)
{
   _intpin = intPin;
   _wire = theWire;
}
...
Others:      none
**********************************************************/
void BMS56M206A::begin(uint8_t addr)
{
...
Others:      none
**********************************************************/
float BMS56M206A::readAccelerationX()
{
      int16_t x = 0;
...
Others:      none
**********************************************************/
float BMS56M206A::readAccelerationY()
{
      int16_t y = 0;
...
Others:      none
**********************************************************/
float BMS56M206A::readAccelerationZ()
{
      int16_t z = 0;
...
Others:      none
**********************************************************/
float BMS56M206A::readGyroscopeX()
{
      int16_t x = 0;
...
Others:      none
**********************************************************/
float BMS56M206A::readGyroscopeY()
{
      int16_t y = 0;
...
Others:      none
**********************************************************/
float BMS56M206A::readGyroscopeZ()
{
      int16_t z = 0;
...
Others:       none
**********************************************************/
void BMS56M206A::setINT(uint8_t mode,uint8_t isEnable)
{
     if(isEnable == true)
     {
...
Others:      none
**********************************************************/
void BMS56M206A::writeReg(uint8_t addr, uint8_t data)
{
...
**********************************************************/
uint8_t  BMS56M206A::readReg(uint8_t addr)
{
    clearBuf();
...
Others:      none
**********************************************************/
void BMS56M206A::readReg(uint8_t addr, uint8_t rBuf[], uint8_t rLen)
{
    clearBuf();
    uint8_t sendBuf[1] = {addr};
    writeBytes(sendBuf,1);
...
**********************************************************/
void BMS56M206A::enableSleep(bool isEnable)
{
  if(isEnable == true)
  {
...
**********************************************************/
void BMS56M206A::enableCycle(bool isEnable)
{
   if(isEnable == true)
  {
...
Others:      none
**********************************************************/
uint8_t BMS56M206A::getAccelerometerRange()
{
...
Others:      none
**********************************************************/
uint8_t BMS56M206A::getGyroRange()
{
      uint8_t rangeValue = 0;
...
Others:      none
**********************************************************/
uint8_t BMS56M206A::getFilterBandwidth()
{
...
Others:      none
**********************************************************/
uint8_t BMS56M206A::getSampleRateDivisor()
{
...
Others:      none
**********************************************************/
uint8_t BMS56M206A::getCycleRate()
{
      uint8_t rateValue = 0; 
...
Others:      none
**********************************************************/
void BMS56M206A::setAccelerometerRange(uint8_t range)
{
      _accrange = range;
...
Others:      none
**********************************************************/
void BMS56M206A::setGyroRange(uint8_t range)
{
      _gyrorange = range;
      switch(_gyrorange)
      {
...
**********************************************************/
void BMS56M206A::setClock(uint8_t clock)
{
...
Others:      none
**********************************************************/
void BMS56M206A::setFilterBandwidth(uint8_t band)
{
...
**********************************************************/
void BMS56M206A::setSampleRateDivisor(uint8_t divisor)
{
...
Others:      none
**********************************************************/
void BMS56M206A::setCycleRate(uint8_t rate)
{
...
Others:      none
**********************************************************/
uint16_t BMS56M206A::readRawTemperature()
{
...
Others:      none
**********************************************************/
void BMS56M206A::readAcceleration(float &accX, float &accY, float &accZ)
{
...
Others:      none
**********************************************************/
void BMS56M206A::readGyroscope(float &gyroX, float &gyroY, float &gyroZ)
{
      int16_t x,y,z;
...
Others:      none
**********************************************************/
void BMS56M206A::readRawAcceleration(int &rawAccX, int &rawAccY, int &rawAccZ)
{
      readReg(REG_ACCEL_XOUT_H,dataBuff,6); 
...
Others:      none
**********************************************************/
void BMS56M206A::readRawGyroscope(int &rawGyroX, int &rawGyroY, int &rawGyroZ)
{
      readReg(REG_GYRO_XOUT_H,dataBuff,6);
...
Others:
**********************************************************/
void BMS56M206A::writeBytes(uint8_t wbuf[], uint8_t wlen)
{
...
Others:      none
**********************************************************/
void BMS56M206A::writeRegBit(uint8_t addr,uint8_t bitNum, uint8_t bitValue)
{
      uint8_t data;
...
Others:
**********************************************************/
void BMS56M206A::readBytes(uint8_t rbuf[], uint8_t rlen)
{
