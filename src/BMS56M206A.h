...
#define _BMS56M206A_H_

#include <Wire.h>
#include <Arduino.h>
/*IIC ADDRESS*/
const uint8_t BMS56M206A_IICADDR = 0x68; //pin AD0 is logic low
//const uint8_t BMS56M206A_IICADDR = 0x69;  //pin AD0 is logic high

class BMS56M206A
{
   public:
       BMS56M206A(uint8_t intPin = 8, TwoWire *theWire = &Wire);
       void begin(uint8_t addr = BMS56M206A_IICADDR);
